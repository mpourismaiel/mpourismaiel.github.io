      ...
      <Tooltip>
        <TooltipTrigger>
          <Link
            ...
            target="_blank"
            className={cn(
              "w-14 h-14 p-2 rounded flex items-center justify-center",
              className,
            )}
          >
            {technologies[title].icon || title}
          </Link>
        </TooltipTrigger>
        <TooltipContent>
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 gap-4">
        <Section title="Languages">
          ...
          <Technology title="Python" description={`print("🐍: " + "s" * 10)`} />
          <Technology
            title="Golang"
        ...
        <Section title="Softwares & Applications">
          ...
          <Technology title="Mysql" description="I use MariaDB to be exact." />
